...
<br><br>
   ...
   <div class="container col-md-4">
     <div class="card card-register mx-auto mt-5">
       <div class="card-header">Olá <?php echo $administrador->getnome();?></div>
         ...
         <form action="alterar_user.php" method="POST" >
            <div class="form-group">
              ...
              <input type="hidden" name="id" value="<?php echo $administrador->getid();?>" >
                 ...
                 <div class="col-md-12">
                    <label>Usuario:</label>
                    <input type="text" class="form-control" name="usuario" placeholder="usuario" value="<?php echo $administrador->getusuario();?>" required>
                  </div>
