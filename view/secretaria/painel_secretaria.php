     ...
     <div class="logo">
        <a href="#  " class="simple-text logo-normal">
           <div class="logo-image-big">
            <img src="../../estilo/img/secretaria.jpg">
          </div> 
        </a>
        ...
        <div class="row">
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-primary o-hidden h-100">
              <div class="card-body">
                <div class="mr-5">Médico</div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="../medico/dados_medico.php">
                <span class="float-left">Ver Dados</span>
              </a>
            </div>
          </div>
